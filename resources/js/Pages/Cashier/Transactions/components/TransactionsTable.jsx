...
import { Search, ArrowRight, Receipt } from "lucide-react";
                            ...
                            <tr>
                                <td colSpan="8" className="px-0 py-0">
                                    <EmptyState
                                        ...
                                        description="No transactions yet. Start by adding a new patient."
                                    />
                                </td>
                            </tr>
                        ) : (
                                    ...
                                    <td className="px-4 py-3">
                                        <span
                                            className={cn(
                                                ...
                                                statusBadge(
                                                    transaction.lab_status
                                                )
                                            )}
                                        >
                                            {transaction.lab_status?.replace(
                                                "_",
                                                " "
                                            )}
                                        </span>
