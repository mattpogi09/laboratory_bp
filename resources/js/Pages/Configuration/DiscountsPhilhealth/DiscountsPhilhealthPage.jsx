...
export default function DiscountsPhilhealthIndex({
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            ...
            router.get(route("discounts-philhealth"), params, {
                preserveState: true,
                preserveScroll: true,
    ...
    const handleToggleDiscount = async (discount) => {
        if (
            ...
            router.post(
                route("discounts.toggle", discount.id),
                {},
                {
                    preserveState: false,
                    preserveScroll: true,
    ...
    const handleTogglePlan = async (plan) => {
        if (
            confirm(
                ...
                } this PhilHealth plan?`
            )
        ) {
            router.post(
                route("philhealth-plans.toggle", plan.id),
                {},
                {
                    preserveState: false,
                    preserveScroll: true,
        ...
        <DashboardLayout auth={auth}>
            ...
            <div className="mb-6 sm:mb-8">
                <h1 className="text-xl sm:text-2xl font-bold text-gray-900">
                    Discounts & PhilHealth Management
                </h1>
            ...
            <div className="border-b border-gray-200 mb-4 sm:mb-6">
                <div className="flex space-x-4 sm:space-x-8">
                    <button
                        ...
                        className={`pb-3 sm:pb-4 px-1 border-b-2 font-medium text-xs sm:text-sm relative ${
                            activeTab === "discounts"
                    ...
                    >
                        <div className="flex items-center gap-1.5 sm:gap-2">
                            ...
                            <span className="sm:hidden">PhilHealth</span>
                        </div>
                    </button>
                </div>
            </div>
            ...
            <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row gap-3 sm:gap-4 relative">
                <div className="relative flex-1">
                    ...
                    <input
                        type="text"
                        placeholder={`Search ${
                            activeTab === "discounts" ? "discounts" : "plans"
                        }...`}
                        className="h-11 sm:h-10 w-full rounded-lg border border-gray-900 bg-white pl-9 sm:pl-10 pr-3 sm:pr-4 text-sm sm:text-base text-gray-900 placeholder:text-gray-500 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                        value={searchQuery}
                ...
                <Button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white min-h-[44px] sm:min-h-0 touch-manipulation"
                >
                            ...
                            <table className="min-w-[800px] w-full">
                                <thead>
                                    <tr className="border-b border-gray-200 bg-gray-50">
                                        ...
                                        <th className="hidden lg:table-cell px-3 sm:px-6 py-3 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">
                                            Description
                                        </th>
                                        <th className="px-3 sm:px-6 py-3 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">
                                            Status
                        ...
                        <table className="min-w-[800px] w-full">
                            <thead>
                                <tr className="border-b border-gray-200 bg-gray-50">
                                    ...
                                    <th className="px-3 sm:px-6 py-3 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider text-nowrap">
                                        <div
                                            className="flex items-center gap-1 cursor-pointer hover:bg-gray-100 rounded px-2 py-1 -mx-2 transition-colors"
                                            onClick={() =>
                                                handleSort("coverage_rate")
                                            }
                                        >
                                            Coverage Rate ↕
                                        </div>
