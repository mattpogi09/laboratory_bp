...
export default function AdjustStockModal({ item, show, onClose }) {
    ...
    const quantityDiff =
        parseInt(data.new_quantity) - parseInt(item.current_stock);
    const isIncrease = quantityDiff > 0;
    const isDecrease = quantityDiff < 0;
    const willBeLowStock =
        data.new_quantity && parseInt(data.new_quantity) < item.minimum_stock;
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">
                                    Manual stock adjustment for {item.name}
                                </p>
                            </div>
                            <button
                                onClick={onClose}
                        ...
                        <div className="bg-white p-4 sm:p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setData("new_quantity", e.target.value)
                                    }
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    <div className="text-sm">
                                        ...
                                        <p className="text-amber-800 mt-1">
                                            This will directly update the stock
                                            level. For normal stock movements,
                                            use Stock In/Out instead.
                                        </p>
                                    </div>
                                </div>
                            </div>
