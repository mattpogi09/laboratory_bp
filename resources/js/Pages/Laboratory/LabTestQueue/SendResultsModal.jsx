...
export default function SendResultsModal({ show, transaction, onClose }) {
    ...
    const handleFileChange = (e, testId) => {
        ...
        setTestDocuments((prev) => ({
            ...prev,
            [testId]: [...(prev[testId] || []), ...files],
        }));
    };

    const removeDocument = (testId, fileIndex) => {
        setTestDocuments((prev) => ({
            ...prev,
            [testId]: prev[testId].filter((_, i) => i !== fileIndex),
        }));
    };
    ...
    const handleConfirmSend = () => {
        // Double-check validation before sending (safety check)
        const incomplete =
            transaction.tests?.filter((test) => {
                const status = (test.status || "").toLowerCase();
                return status === "pending" || status === "processing";
        ...
        // Append documents for each test
        Object.entries(testDocuments).forEach(([testId, files]) => {
            files.forEach((file, index) => {
                formData.append(`test_documents[${testId}][${index}]`, file);
            });
        });
        ...
        router.post(route("lab-test-queue.send-results"), formData, {
            ...
            onError: (errors) => {
                ...
                setErrorMessage(
                    errors?.error || "Failed to send results. Please try again."
                );
                setShowError(true);
            },
        });
    ...
    return (
        <>
            <LoadingOverlay
                show={processing}
                message="Generating PDFs and sending email..."
            />
                        ...
                        <div className="relative w-full max-w-md bg-white rounded-xl shadow-xl">
                            ...
                            <div className="px-6 py-4">
                                <p className="text-sm text-gray-700 mb-4">
                                    ...
                                    Please process them first before sending the
                                    results:
                                </p>

                                <div className="space-y-2 mb-4">
                                    {transaction.incompleteTests.map(
                                        (test, index) => (
                                            <div
                                                key={index}
                                ...
                                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                    <p className="text-xs text-blue-800">
                                        ...
                                        before sending results to the patient.
                                    </p>
                                </div>
                            </div>
                                                            ...
                                                            <div className="mt-3">
                                                                ...
                                                                <div className="border-2 border-dashed border-gray-300 rounded-lg p-3 text-center bg-white">
                                                                    ...
                                                                    <label className="cursor-pointer">
                                                                        <span className="text-xs text-red-600 hover:text-red-700 font-medium">
                                                                            Click
                                                                            to
                                                                            upload
                                                                        </span>
                        ...
                        <div className="relative w-full max-w-md bg-white rounded-xl shadow-xl p-6">
                            <div className="text-center">
                                ...
                                <p className="text-sm text-gray-600 mb-6">
                                    Are you sure you want to send the results to
                                    <br />
