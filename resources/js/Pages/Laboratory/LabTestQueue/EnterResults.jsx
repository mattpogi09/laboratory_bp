        ...
        <DashboardLayout auth={auth}>
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600">
                    Update findings for queue #{test.queue_number} -{" "}
                    {test.transaction_number}
                </p>
            </div>
                    ...
                    <dl className="mt-4 space-y-3 text-sm text-gray-600">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <dd className="font-medium text-gray-900">
                                    {test.transaction?.patient?.age || "—"}
                                </dd>
                            </div>
                            <div>
                                <dt className="text-gray-500">Gender</dt>
                                <dd className="font-medium text-gray-900">
                                    {test.transaction?.patient?.gender || "—"}
                                </dd>
                            </div>
                            <div>
                                <dt className="text-gray-500">Email</dt>
                                <dd className="font-medium text-gray-900">
                                    {test.transaction?.patient?.email || "—"}
                                </dd>
                            </div>
                        </div>
                        <div>
                            ...
                            <dd className="font-medium text-gray-900">
                                {test.transaction?.patient?.contact || "—"}
                            </dd>
                        </div>
                        <div>
                    ...
                    <form onSubmit={handleSubmit} className="mt-4 space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    handleChange("result_value", e.target.value)
                                }
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    handleChange("normal_range", e.target.value)
                                }
                                className="mt-1 w-full rounded-lg border border-gray-200 px-3 py-2 text-gray-900 focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500/20"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={(e) =>
                                    handleChange("result_notes", e.target.value)
                                }
