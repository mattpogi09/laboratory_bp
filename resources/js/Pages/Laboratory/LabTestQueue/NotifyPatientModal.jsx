...
export default function NotifyPatientModal({ show, transaction, onClose }) {
    ...
    const testNames =
        transaction.tests?.map((test) => test.test_name).join(", ") || "";
            ...
            <div className="p-6">
                ...
                <div className="mb-6 rounded-lg bg-gray-50 border border-gray-200 p-4 space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-900">
                            {transaction.patient_address || "No address"}
                        </span>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="mb-6">
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-4 text-sm text-gray-700 space-y-2">
                        <p className="font-medium">
                            Subject: Your Lab Test Results are Ready - BP
                            Diagnostic
                        </p>
                        <div className="mt-3 pt-3 border-t border-gray-200 space-y-2">
                            ...
                            <p>
                                We are pleased to inform you that your test
                                results for the following are now ready for
                                claiming:
                            </p>
                            ...
                            <p>
                                You may now visit our laboratory to pick up your
                                results during our operating hours.
                            </p>
                            <p>
                                Transaction Code:{" "}
                                <strong>
                            ...
                            <div className="px-6 py-4">
                                ...
                                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                    <p className="text-xs text-blue-800">
                                        ...
                                        before sending notification to the
                                        patient.
                                    </p>
                                </div>
                            </div>
