        ...
        <DashboardLayout auth={auth}>
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600">
                    View all sent patient test results
                </p>
            </div>
            ...
            <div className="mb-6 flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex gap-2">
                    <select
                        ...
                        className="h-10 rounded-lg border border-gray-900 bg-white px-4 text-gray-900 focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500/20"
                    >
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-gray-200 bg-gray-50">
                                ...
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider wrap text-nowrap">
                                    Tests Sent
                                </th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Email
                            ...
                            {sentResults.data?.length === 0 ? (
                                ...
                                sentResults.data?.map((result) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 wrap text-nowrap">
                ...
                {sentResults.last_page > 1 && (
                    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-6 py-3">
                        <div className="flex flex-1 justify-between sm:hidden">
                            <button
                                onClick={() =>
                                    router.get(sentResults.prev_page_url)
                                }
                            ...
                            <button
                                onClick={() =>
                                    router.get(sentResults.next_page_url)
                                }
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <span className="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300">
                                        {sentResults.current_page} /{" "}
                                        {sentResults.last_page}
                                    </span>
                                    <button
                                        onClick={() =>
                                            router.get(
                                                sentResults.next_page_url
                                            )
                                        }
                                        disabled={!sentResults.next_page_url}
