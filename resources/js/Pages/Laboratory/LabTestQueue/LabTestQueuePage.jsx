        ...
        <DashboardLayout auth={auth}>
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600">
                    Live queue synced from cashier transactions
                </p>
            </div>
            ...
            <div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-4">
                <StatCard
                    label="Pending Tests"
                    value={stats.pending || counts.pending}
                    icon={AlertCircle}
                    color="bg-red-500"
                />
                <StatCard
                    label="Processing"
                    value={stats.processing || counts.processing}
                    icon={Clock}
                    color="bg-yellow-500"
                />
                <StatCard
                    label="Completed Today"
                    value={stats.completed_today || counts.completed}
                    icon={CheckCircle}
                    color="bg-blue-500"
                />
                <StatCard
